...
Produce a short SE starter pack for **either**:
...
Write a **short vision statement** (½–1 page max) that creates a shared perspective:

- Future state of the system / phase  
- Who it serves  
...
About 2 pages equivalent. Clarity over volume.

## Quality bar

- Someone new can restate your vision in 60 seconds  
- Stakeholder is a **role or unit**, not “users”  
- Need is capability language, **not** a design choice  
- Benefit is valuable to that stakeholder  
- Vision / need / design are not mixed  

## Rubric (see catalog)

completeness · boundary_clarity · communication
