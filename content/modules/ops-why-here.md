...
> **Audience:** every intern, every track. Week 1 Monday, first 45 minutes, **one room**.  
...
After 45 minutes you can:

- Say in one sentence **why CISS exists** (a picture that is true)  
- Name the **four rooms** and the **one problem** they share  
...
```text
Week 1 Monday     ALL-HANDS opener (this module, 45 min)
...
| Today | Later |
|-------|--------|
| Hear why the picture matters | Weeks 10–11: learn AOC / ATO vocabulary |
| See a **teaching** air picture (projector) | Week 14: **ops-prsas-intro** — why PRSAS, after you have the ops words |
...
Play the **teaching picture** (stylized gulf, three sites, fused tracks). Say out loud:

1. Remote A and Remote B are **sensors**.  
2. Central is **fusion + glass**.  
...
| Allowed | Not allowed |
|---------|-------------|
| Classroom picture, simulated feeds | Live AD sensors, real tracks, real IFF Mode 4/5 |
| Public MoD / WAM language when the instructor cites it | Inventing intercept rates or basing |
| “We will build the *shape* of a picture” | “We are building the UAE’s missile shield” |
